...
int main(int argc, char** argv) {
    ...
    float Calib_3D_mid_C = 0.0000878028;
    float Calib_3D_W1_C  = 0.0000070292;
    float Calib_3D_W2_C  = 0.0000217795;
    float Calib_3D_W3_C  = 0.0000183036;
    float Calib_HS_W_C   = 0.0000684914;
    float Calib_HS_1_C   = 0.0000598470;
    float Calib_HS_2_C   = 0.0000582467;
    float Calib_HS_3_C   = 0.0000623085;
    float Calib_L_1_C    = 0.0000688538;
    float Calib_L_2_C    = 0.0003935991;
    float Calib_L_3_C    = 0.0000736335;
    float Calib_L_4_C    = 0.0001363209;

    float Calib_3D_mid_S = 0.0000424657;
    float Calib_3D_W1_S  = 0.0000044217;
    float Calib_3D_W2_S  = 0.0000049331;
    float Calib_3D_W3_S  = 0.0000051242;
    float Calib_HS_W_S   = 0.0000400015;
    float Calib_HS_1_S   = 0.0000345800;
    float Calib_HS_2_S   = 0.0000366323;
    float Calib_HS_3_S   = 0.0000353918;
    float Calib_L_1_S    = 0.0000417804;
    float Calib_L_2_S    = 0.0000254455;
    float Calib_L_3_S    = 0.0000452643;
    float Calib_L_4_S    = 0.0000689327;
    ...
    // Save the outputs
    std::string outFile = "./CalibAtOnce/CalibAtOnce_EvtPed_Run_" + std::to_string(runNum) + "_24Feb06ReCalib.root";
