...
parser.add_argument('--mid', '-m', nargs='+', type=int, help="Provide list of MIDs to run ntupler", required=True)
...
MIDvec = ROOT.std.vector('int')(args.mid)
ntupler = ROOT.TBntupler("/u/user/swkim/SE_UserHome/2023_DRC_TB_Data", outputPath, outFileName, rn, args.MaxEntry, args.FileEntry, MIDvec)
# ntupler = ROOT.TBntupler("/u/user/swkim/SE_UserHome/2023_DRC_TB_Data", outputPath, outFileName, rn, args.MaxEntry, args.FileEntry)
