...
int main(int argc, char** argv) {
    ...
    for (int iEvt = 0; iEvt < totalEntry; iEvt++) {
        ...
        // Fill Histo
        float PeakADC_C_counter_1 = GetPeakWithPed(Wave_C_counter.at(0), 400, 680, Ped_C_counter.at(0));
        float PeakADC_C_counter_2 = GetPeakWithPed(Wave_C_counter.at(1), 220, 480, Ped_C_counter.at(1));
    ...
    // Save the outputs
    std::string outFile = "./Equalization/Equalization_Run_" + std::to_string(runNum) + ".root";
